...
/**
 *
 * @api {post} /database/rubber/machineRate 新增  Machine Rate / 穴數
 * @apiName 新增  Machine Rate / 穴數
 * @apiGroup database rubber
 * @apiHeader {String} Authorization Bearer access-token.
 *
...
rubberRouter.post('/machineRate', authHelpers.isJWTAuthenticated, rubbers.postMachineRate)

/**
 *
 * @api {post} /database/rubber/archive/machineRate 封存  Machine Rate / 穴數
 * @apiName 封存  Machine Rate / 穴數
 * @apiGroup database rubber
 * @apiHeader {String} Authorization Bearer access-token.
 *
 * @apiSuccessExample {json} Request-Example:
...
{
  "machineRateId": [
    "2eb48fc0-e5bf-11e9-af51-0242ac110002",
  ]
}
 *
 * @apiError 401 Unauthorized
 * @apiError 403 PERMISSION DENIED
 * @apiSampleRequest /database/rubber/archive/machineRate
 */

rubberRouter.post('/archive/machineRate', authHelpers.isJWTAuthenticated, rubbers.archiveMachineRate)

/**
 *
 * @api {post} /database/rubber/unblock/machineRate 解封存  Machine Rate / 穴數
 * @apiName 解封存  Machine Rate / 穴數
 * @apiGroup database rubber
 * @apiHeader {String} Authorization Bearer access-token.
 *
 * @apiSuccessExample {json} Request-Example:
 ...
 * @apiError 401 Unauthorized
 * @apiError 403 PERMISSION DENIED
 * @apiSampleRequest /database/rubber/unblock/machineRate
 */

rubberRouter.post('/unblock/machineRate', authHelpers.isJWTAuthenticated, rubbers.unblockMachineRate)
